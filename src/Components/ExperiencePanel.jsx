  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/40 backdrop-blur-sm z-50 p-4">
      ...
      <Motion.div
        ...
        className="relative w-[95%] md:w-[850px] max-w-[95%] md:max-w-[92%] h-[85vh] md:h-[540px] bg-white/90 rounded-2xl shadow-2xl overflow-hidden flex flex-col"
      >
        
        {/* Top Bar */}
        <div className="flex justify-between items-center px-4 md:px-5 py-3 border-b bg-white/60">
        ...
        {/* Scrollable Content */}
        <div className="p-4 md:p-6 flex-1 overflow-y-auto space-y-5 pr-2">
          ...
          {experiences.map((exp, index) => (
            <Motion.div
              ...
              className="bg-white/70 border border-gray-200 rounded-xl p-4 md:p-5 shadow-sm hover:shadow-md transition cursor-pointer"
            >
